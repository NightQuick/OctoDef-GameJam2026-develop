...
static func place_selected_tower(tree_scene, possition: Vector2, placed_node: PackedScene, GettingTileMap: TileMapLayer):
...
static func find_tiles_by_id(id_atlas : int, need_tiles : Vector2i, TMap : TileMapLayer):
